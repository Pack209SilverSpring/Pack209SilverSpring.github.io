...
<section class="px-4 mt-12 mb-12 sm:px-6 lg:px-8 sm:mt-16">
  <div class="grid max-w-6xl gap-6 mx-auto md:grid-cols-2">
    <a href="/register"
       class="group block p-8 transition font-heading rounded-[5px] bg-cub-gold ring-1 ring-cub-blue hover:bg-yellow-300 no-underline">
    ...
    <a href="mailto:cubmaster@cubscoutpack209.org?subject=Question%20about%20Pack%20209"
       ...
       class="group block p-8 transition font-heading bg-white rounded-[5px] ring-1 ring-cub-blue hover:bg-slate-50 no-underline">
      <h2 class="mt-0 mb-0 text-2xl font-bold tracking-tight text-cub-blue sm:text-3xl">
        {{ page.cards[1].title }}
      </h2>
